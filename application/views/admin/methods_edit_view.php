			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["author"]?><span class='gfield_required'>*</span>:</label>
				...
				<div class='ginput_container'>					
					<?php 						
						foreach ($languages as $value):
							?>
							<input name='author' language="<?php echo $value['id'];?>" type='text' value='<?php echo $entry['author'][$value['id']];?>' class='medium' tabindex='3'/>
							<?php								
						endforeach;						
					?>
				</div>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["links"]?>: </label>
				...
				<div class='ginput_container'>					
					<?php 						
						foreach ($languages as $value):
							?>
							<div class="textarea" name='links' language="<?php echo $value['id'];?>">
								<textarea class='textarea small' tabindex='5' rows='10' cols='50'><?php echo $entry['links'][$value['id']]?></textarea>
							</div>
							<?php								
						endforeach;						
					?>
