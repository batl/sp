			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["suname"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>					
					<?php 						
						foreach ($languages as $language):
							?>
							<input name='suname' language="<?php echo $language['id'];?>" type='text' value='<?php echo $entry['suname'][$language['id']];?>' class='medium' tabindex='3'/>
							<?php								
						endforeach;						
					?>
				</div>
					...
					<?php 						
						foreach ($languages as $language):
							...
							<div class="textarea" name='about' language="<?php echo $language['id'];?>">
								<textarea class='textarea small' tabindex='5' rows='10' cols='50'><?php echo $entry['about'][$language['id']];?></textarea>		
							</div>
							<?php								
						endforeach;						
					?>
