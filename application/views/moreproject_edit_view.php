		...
		<ul class='gform_fields top_label'>			
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["resourses"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>
					...
					?>
					<a class="document_file" href="<?php echo $base?>doc/<?php echo $entry['resourses']?>"><?php echo $lang["resourses"].'('.$lang["download_view"].')'?></a>
					<?php
					else:
					?>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["project_plan"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>
					...
					?>
					<a class="document_file" href="<?php echo $base?>doc/<?php echo $entry['project_plan']?>"><?php echo $lang["project_plan"].'('.$lang["download_view"].')'?></a>
					<?php
					else:
					?>
					<a class="document_file" href="javascript:void(0);"><?php echo $lang["not_download"]?></a>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["application_form"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>
					...
					?>
					<a class="document_file" href="<?php echo $base?>doc/<?php echo $entry['application_form']?>"><?php echo $lang["application_form"].'('.$lang["download_view"].')'?></a>
					<?php
					else:
					?>
					<a class="document_file" href="javascript:void(0);"><?php echo $lang["not_download"]?></a>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["business_plan"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>
					...
					?>
					<a class="document_file" href="<?php echo $base?>doc/<?php echo $entry['business_plan']?>"><?php echo $lang["business_plan"].'('.$lang["download_view"].')'?></a>
					<?php
					else:
					?>
					<a class="document_file" href="javascript:void(0);"><?php echo $lang["not_download"]?></a>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["scheme_budget"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>
					...
					?>
					<a class="document_file" href="<?php echo $base?>doc/<?php echo $entry['scheme_budget']?>"><?php echo $lang["scheme_budget"].'('.$lang["download_view"].')'?></a>
					<?php
					else:
					?>
					<a class="document_file" href="javascript:void(0);"><?php echo $lang["not_download"]?></a>
