		...
		<ul class='gform_fields top_label'>								
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang['banner']?><span class='gfield_required'>*</span></label>
				<div id="photo-preview">
					<img id="project_banner" language="no" name="banner" big="<?php echo $entry['banner']?>" style="max-height:100px; max-width:100px;" src="<?php echo $base.$entry['banner']?>"/>
				</div>
				<div class='ginput_container'>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang["date"]?><span class='gfield_required'>*</span>:</label>
				<div class='ginput_container'>
					<input name='date' language="no" type='text' value='<?php echo $entry['date']?>' class='medium picker' tabindex='3'/>
				</div>
			</li>
			...
			<li class='gfield'><label class='gfield_label'><?php echo $lang['site_background']?><span class='gfield_required'>*</span></label>
				<div id="photo-preview">
					<img id="site_background" language="no" name="bg_image" big="<?php echo $entry['bg_image']?>" style="max-height:100px; max-width:100px;" src="<?php echo $base.$entry['bg_image']?>"/>
				</div>
				<div class='ginput_container'>
