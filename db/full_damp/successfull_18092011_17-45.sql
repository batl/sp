...
--
-- Хост: localhost
-- Время создания: Сен 18 2011 г., 17:45
...
CREATE TABLE IF NOT EXISTS `sp_projectsstages_partners` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Связь проэкта и его партнеров' AUTO_INCREMENT=3 ;
...
('b708d32d8bb3be2115f257833c9163ee', '127.0.0.1', 'Mozilla/5.0 (Windows NT 5.1; rv:6.0) Gecko/2010010', 1316356942, 'a:3:{s:4:"lang";s:7:"russian";s:7:"lang_id";s:1:"1";s:8:"admin_id";s:2:"22";}');
